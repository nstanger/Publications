...
% 
%     \item \(\TSSNL \ProjectionEdge \T{\City} \setminus \CityLondon\)
% 
% \end{itemize}
...
\begin{table*}
    ...
    \begin{tabular}{cl}
        ...
        {\Constraint[\SC{1}]{\ref{constraint-key}}}(c)          &   \(\T{\Sno} \KeyEdge \TSSNL\)   \\
        \midrule
        {\Constraint[\SC{1}]{\ref{constraint-relation-types}}}  &   \(\T{S} \SelectionEdge \T{\LSsub}\)   \\
            &   \(\TT{S} \SelectionEdge \TT{\LSsub}\)   \\
        \midrule
        {\Constraint[\SC{1}]{\ref{constraint-tuple-types}}}     &   \(\T{S} \SelectionEdge \T{\NLSsub}\)   \\
            &   \(\TT{S} \SelectionEdge \TT{\NLSsub}\)   \\
        \midrule
...
%     
%     \item \(\TSSC \SelectionEdge \T{\Sname} \times \T{\Status} \times \T{\City} \setminus \CityLondon\)
% 
% \end{itemize}
