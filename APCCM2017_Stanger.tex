...
\begin{figure*}[t]
    ...
    \begin{tikzpicture}
        ...
        \graph{
            ...
            % transformation indicators
            { [edges={->,gray,dashed}]
                (c1a) -- [edge node={node[sloped,above]{\small\emph{copy \& move}}}] (c1b),
                (c1a) -- [bend right=12] (c1c),
